...
export const SOLANA_USDC_ADDRESS =
  process.env.SOLANA_USDC_ADDRESS ?? "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v";
export const USER_TOKEN_ACCOUNT =
  process.env.USER_TOKEN_ACCOUNT ?? "HXiPvmzuZAAUxbuTVaCMu38PcqcmiML3pBFdAiYRdXyL";
